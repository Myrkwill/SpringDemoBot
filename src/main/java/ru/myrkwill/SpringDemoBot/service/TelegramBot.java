...
import ru.myrkwill.SpringDemoBot.config.BotConfig;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public TelegramBot(BotConfig config) {
        ...
        botCommandList.add(new BotCommand("/mydata", "get your data store"));
        botCommandList.add(new BotCommand("/deletadata", "delete my data"));
